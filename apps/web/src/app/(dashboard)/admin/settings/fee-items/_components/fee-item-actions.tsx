...
interface FeeItemActionsProps {
    id: string
    canDelete: boolean
}

export function FeeItemActions({ id, canDelete }: FeeItemActionsProps) {
        ...
        <div className="relative inline-block text-left">
            {canDelete ? (
                ...
                <button
                    ...
                    title="Cannot delete fee item in use"
                >
                    <Trash2 className="w-4 h-4" />
                </button>
            )}
            ...
            {showDeleteConfirm && (
                <div className="absolute right-0 top-10 mt-2 w-72 bg-white rounded-xl shadow-xl border border-red-100 p-4 z-50">
                    <div className="flex gap-3 mb-3 text-red-600">
                        ...
                        <div>
                            <h4 className="text-sm font-semibold">Delete Fee Item?</h4>
